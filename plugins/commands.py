...
HOME_TEXT = "<b>Hey  [{}](tg://user?id={}) 🙋‍♂️\n\nIam A Bot Built To Play or Stream Videos In @MSPmoviesOffl VoiceChats.\nJoin Our Discussion @MSPdiscussion</b>"
...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/MSPmoviesOffl'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/MSPbots')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/MSPbots'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/MSPmoviesOffl'),
            
        ],
    ]
    await message.reply("<b>The source code of this bot is Private😇, If You Want Send Me $100😝</b>", reply_markup=InlineKeyboardMarkup(buttons))
